...
def parse_args():
    ...
    parser.add_argument('--mean-r', dest='mean_r', type=float, default=123,
                        help='red mean value')
    parser.add_argument('--mean-g', dest='mean_g', type=float, default=114,
    ...
    parser.add_argument('--freeze', dest='freeze_pattern', type=str, default=None,
    ...
    parser.add_argument('--overlap', dest='overlap_thresh', type=float, default=0.4,
